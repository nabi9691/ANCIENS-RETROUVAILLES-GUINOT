...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getDoctrine_FixturesLoadCommandService()
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\ContactsFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\MediatsFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\MessagesFixtures(), 'groups' => []]]);
